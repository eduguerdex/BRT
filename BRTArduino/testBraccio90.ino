...
void setup() {  
  ...
  Braccio.ServoMovement(30,90, 90, 180, 0, 0,  0);
}
...
void loop() {
  ...
  */
  ...
  //Braccio.ServoMovement(20,90, 90, 125, 90, 90,  0);
 
  Braccio.ServoMovement(20,120, 125, 125, 110, 0,  0);   
  Braccio.ServoMovement(20,0, 125, 125, 110, 0,  90);
