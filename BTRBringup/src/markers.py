...
class BallMarker(object):
    ...
    def __init__(self, color, alpha=1.0, scale=0.5):
        """
    ...
    def position(self, T):
        ...
        """
        self.marker.pose.position.x = T[1,3]*3
        self.marker.pose.position.y = T[2,3]*50
        self.marker.pose.position.z = T[0,3]*-0.5
        self.publish()
    ...
    def xyz(self, position):
        ...
        """
        self.marker.pose.position.x = position[1]*1
        self.marker.pose.position.y = position[2]*1
        self.marker.pose.position.z = position[0]*1
        self.publish()
